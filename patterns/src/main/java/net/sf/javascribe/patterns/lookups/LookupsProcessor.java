...
import net.sf.javascribe.patterns.xml.lookups.Entity;
import net.sf.javascribe.patterns.xml.lookups.Field;
import net.sf.javascribe.patterns.xml.lookups.FieldValue;
import net.sf.javascribe.patterns.xml.lookups.Lookups;
